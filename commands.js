...
db.bounties.insertOne({ name: "Thaneceros", species: "rhinoceros", location: "Grasslands", wantedFor: "Eating too much grass", client: "Songbird", reward: 1000, captured: false})
...
db.bounties.find({"reward": {$gte: 1000}}, {client: 0})
...
// 2. Remove Lokinkajou
db.collectionName.deleteOne({name: "Lokinkajou"}) 
